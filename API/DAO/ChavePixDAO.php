...
class ChavePixDAO extends DAO
{
    ...
    public function Salvar(ChavePixModel $model) : ?ChavePixModel
    {
        return ($model->id == null) ? $this->Inserir($model) : $this->update($model);
    }
     ...
     */
    public function Inserir(ChavePixModel $model) : ?ChavePixModel
    {
